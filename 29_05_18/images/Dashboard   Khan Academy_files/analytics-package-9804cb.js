...
return React.createElement("script",{dangerouslySetInnerHTML:{__html:makeEventMarker(e)}})}
...
var getEarlyUsableWindowProp=exports.getEarlyUsableWindowProp=function a(){return EARLY_USABLE_WINDOW_PROP}
var resetEarlyUsableIndicators=function t(){window[EARLY_USABLE_WINDOW_PROP]={}}
var earlyUsableTimeForPage=function r(e){return window[EARLY_USABLE_WINDOW_PROP]&&window[EARLY_USABLE_WINDOW_PROP][e]}
var markPageviewConversion=function n(e){return _bigbingo2.default.markConversion("pageview",{path:e,qs:window.location.search.slice(1),utc:-(new Date).getTimezoneOffset()})}
var checkMarkHomepageConversion=function i(e){var a=!!e&&e.split("/").join("")===""
if(a){var t=_ka2.default.isLoggedIn()
if(t){_bigbingo2.default.markConversion("pageview_logged_in_homepage")}else{_bigbingo2.default.markConversion("pageview_logged_out_homepage")}}}
var markNavConversions=function s(e){var a={path:e,qs:window.location.search.slice(1),utc:-(new Date).getTimezoneOffset()}
var t=[{id:"pageview",extra:a},{id:"pagerequest",extra:a}]
_bigbingo2.default.markConversionsWithExtras(t)}
...
var reportPageLifecycleTiming=exports.reportPageLifecycleTiming=function u(e){var a=arguments.length>1&&arguments[1]!==undefined?arguments[1]:false
...
var i=perf.now()
var s=state.clientSide?"client":"server"
var o=null
var l=null
var g=null
if(a&&!state.fullyInteractiveTime){var u=Math.round(i-state.startTime)
n.fullyInteractiveTime=u
o=u}if(t&&!state.sufficientlyUsableTime){var f=Math.round((earlyUsableTimeForPage(e)||i)-state.startTime)
n.sufficientlyUsableTime=f
l=f}if(!state.clientSide&&!state.firstByteTime){var p=perf.timing.responseStart-perf.timing.navigationStart
n.firstByteTime=p
g=p}update(n)
if(o!==null||l!==null||g!==null){return(0,_khanFetch.khanFetch)("/api/internal/_mt/page_perf_log",{method:"POST",headers:{"Content-Type":"application/json"},body:JSON.stringify({originalRequestId:_ka2.default.requestLogId,pageName:e,navigation:s,sufficientlyUsable:l,fullyInteractive:o,firstByte:g})})}}return Promise.resolve()}
var reportPageInteractiveTiming=exports.reportPageInteractiveTiming=function f(e){var a=arguments.length>1&&arguments[1]!==undefined?arguments[1]:false
return reportPageLifecycleTiming(e,true,false,a)}
var reportPageUsableTiming=exports.reportPageUsableTiming=function p(e){var a=arguments.length>1&&arguments[1]!==undefined?arguments[1]:false
return reportPageLifecycleTiming(e,false,true,a)}
});
